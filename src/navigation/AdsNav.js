// stack navigation display which help a User to create an ads
  ...
  render() {
    return (
      <Stack.Navigator>
        ...
        />
        <Stack.Screen name="Description" component={AdFields} />

        <Stack.Screen name="DateTime" component={DateTimer} />
        <Stack.Screen name="Adresse" component={AdressePrice} />
      </Stack.Navigator>
    );
  }
}
