// Our register form to let an User create his account
      ...
      <ScrollView>
        <ImageBackground
          ...
          <View style={styles.cnt3}>
            <Text style={styles.txt3}>Create Your Account</Text>
          </View>
          <View style={styles.cnt2}>
            <TextInput
              style={styles.input1}
              placeholder="first name"
              onChangeText={text => this._firstChange(text)}
            />
          </View>
          ...
          <View style={styles.cnt2}>
            <TextInput
              ...
              onChangeText={text => this._lastChange(text)}
            />
          </View>
          ...
          <View style={styles.cnt2}>
            <TextInput
              style={styles.input1}
              placeholder="City"
              onChangeText={text => this._citychange(text)}
            />
          </View>
          <View style={styles.cnt2}>
            <TextInput
          ...
          <View style={styles.cnt2}>
            <TextInput
              ...
              secureTextEntry={true}
              onChangeText={text => this._confpasswordChange(text)}
            />
          </View>
