// this is our main login form to allow user to create an account or to Login in to his account
...
export default class LoginScreen extends Component {
  ...
  render() {
    return (
      <ImageBackground
        source={require('../pictures/font1.png')}
        style={styles.smallcontainer}>
        <View style={styles.test}>
          <View style={styles.blockImg}>
            <Image
              style={styles.picture}
              source={require('../pictures/letjob.png')}
            />
          </View>
          <View>
